...
#SBATCH --output=logs/dou_harmonization_devstral_%j.out
#SBATCH --error=logs/dou_harmonization_devstral_%j.err
...
echo "Config: experiments/configs/dou_harmonization_devstral.yaml"
echo ""
...
python run_experiment.py \
    --config experiments/configs/dou_harmonization_devstral.yaml \
