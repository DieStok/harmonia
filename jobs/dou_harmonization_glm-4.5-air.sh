...
echo "=============================================="
echo "Harmonia Experiment: dou_harmonization_glm-4.5-air"
echo "=============================================="
echo ""
...
echo "Config: experiments/experiment_1_harmonia_dou2020_gdc/configs/automated/dou_harmonization_glm-4.5-air.yaml"
echo ""
