...
LOG_OUT="logs/${LOG_TIMESTAMP}_dou_harmonization_code-context_nemotron-3-nano_${SLURM_JOB_ID}_${RUN_ID}.out"
LOG_ERR="logs/${LOG_TIMESTAMP}_dou_harmonization_code-context_nemotron-3-nano_${SLURM_JOB_ID}_${RUN_ID}.err"
mkdir -p logs
exec > "$LOG_OUT" 2> "$LOG_ERR"

echo "=============================================="
echo "Harmonia Experiment (GPU): dou_harmonization_code-context_nemotron-3-nano"
echo "=============================================="
echo ""
...
echo "Config: experiments/experiment_1_harmonia_dou2020_gdc/configs/automated/dou_harmonization_code-context_nemotron-3-nano.yaml"
echo ""
