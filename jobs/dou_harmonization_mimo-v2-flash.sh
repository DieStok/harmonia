...
#SBATCH --output=logs/dou_harmonization_mimo-v2-flash_%j.out
#SBATCH --error=logs/dou_harmonization_mimo-v2-flash_%j.err
...
echo "=============================================="
echo "Harmonia Experiment (GPU): dou_harmonization_mimo-v2-flash"
echo "=============================================="
echo ""
...
echo "Pre-loading model xiaomi/mimo-v2-flash:free..."
curl -s http://localhost:11434/api/generate -d "{\"model\": \"xiaomi/mimo-v2-flash:free\", \"prompt\": \"Hello\", \"stream\": false}" > /dev/null 2>&1 || echo "  Warning: Model pre-load may have failed"
