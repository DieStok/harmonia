...
#SBATCH --job-name=harmonia_dou_harmonization_devstral-small
#SBATCH --output=logs/dou_harmonization_devstral-small_%j.out
#SBATCH --error=logs/dou_harmonization_devstral-small_%j.err
...
echo "=============================================="
echo "Harmonia Experiment (GPU): dou_harmonization_devstral-small"
echo "=============================================="
echo ""
...
echo "Pre-loading model devstral-small-2:latest..."
curl -s http://localhost:11434/api/generate -d "{\"model\": \"devstral-small-2:latest\", \"prompt\": \"Hello\", \"stream\": false}" > /dev/null 2>&1 || echo "  Warning: Model pre-load may have failed"
...
echo "LLM Model: devstral-small-2:latest"
...
apptainer exec \
    ...
    --env LLM_SERVICE_MODEL=devstral-small-2:latest \
...
echo "Config: experiments/configs/dou_harmonization_devstral-small.yaml"
echo ""
...
python run_experiment.py \
    --config experiments/configs/dou_harmonization_devstral-small.yaml \
