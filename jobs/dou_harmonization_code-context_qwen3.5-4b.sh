...
# Source config: experiments/experiment_1_harmonia_dou2020_gdc/configs/automated/dou_harmonization_code-context_qwen3.5-4b.yaml
# Template: sbatch_template_gpu.sh
# Re-generate with: python generate_jobs.py --config experiments/experiment_1_harmonia_dou2020_gdc/configs/automated/dou_harmonization_code-context_qwen3.5-4b.yaml
# ------------------------------------------------------------
# =============================================================================
...
#SBATCH --job-name=harmonia_dou_harmonization_code-context_qwen3.5-4b
...
RUN_RESULTS_DIR="results/${TIMESTAMP}_dou_harmonization_code-context_qwen3.5-4b_${SLURM_JOB_ID}_${RUN_ID}"
mkdir -p "$RUN_RESULTS_DIR"

# Redirect all output to date-stamped log files (includes run_id)
LOG_TIMESTAMP=$(date +%d-%m-%Y_%H%M)
LOG_OUT="logs/${LOG_TIMESTAMP}_dou_harmonization_code-context_qwen3.5-4b_${SLURM_JOB_ID}_${RUN_ID}.out"
LOG_ERR="logs/${LOG_TIMESTAMP}_dou_harmonization_code-context_qwen3.5-4b_${SLURM_JOB_ID}_${RUN_ID}.err"
mkdir -p logs
exec > "$LOG_OUT" 2> "$LOG_ERR"

echo "=============================================="
echo "Harmonia Experiment (GPU): dou_harmonization_code-context_qwen3.5-4b"
echo "=============================================="
echo ""
...
./exec_apptainer_harmonia.sh \
    --port $PORT \
    --config experiments/experiment_1_harmonia_dou2020_gdc/configs/automated/dou_harmonization_code-context_qwen3.5-4b.yaml \
    --job-name "dou_harmonization_code-context_qwen3.5-4b_${SLURM_JOB_ID}" \
...
echo "Config: experiments/experiment_1_harmonia_dou2020_gdc/configs/automated/dou_harmonization_code-context_qwen3.5-4b.yaml"
echo ""

# Get token from env file
TOKEN=$(grep "^JUPYTER_TOKEN=" experiments/experiment_1_harmonia_dou2020_gdc/configs/automated/dou_harmonization_code-context_qwen3.5-4b_associated.env | cut -d '=' -f2)
