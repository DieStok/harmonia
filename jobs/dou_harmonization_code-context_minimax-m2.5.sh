...
# Source config: experiments/experiment_1_harmonia_dou2020_gdc/configs/automated/dou_harmonization_code-context_minimax-m2.5.yaml
# Template: sbatch_template.sh
# Re-generate with: python generate_jobs.py --config experiments/experiment_1_harmonia_dou2020_gdc/configs/automated/dou_harmonization_code-context_minimax-m2.5.yaml
# ------------------------------------------------------------
# =============================================================================
...
RUN_RESULTS_DIR="/hpc/compgen/projects/llm_GEO_project/harmonia_metadata_agent/analysis/dstoker/harmonia/results/${TIMESTAMP}_dou_harmonization_code-context_minimax-m2.5_${SLURM_JOB_ID}_${RUN_ID}"
...
TOKEN=$(grep "^JUPYTER_TOKEN=" experiments/experiment_1_harmonia_dou2020_gdc/configs/automated/dou_harmonization_code-context_minimax-m2.5_associated.env | cut -d '=' -f2)
