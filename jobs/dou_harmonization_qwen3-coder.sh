...
LOG_OUT="logs/${LOG_TIMESTAMP}_dou_harmonization_qwen3-coder_${SLURM_JOB_ID}.out"
LOG_ERR="logs/${LOG_TIMESTAMP}_dou_harmonization_qwen3-coder_${SLURM_JOB_ID}.err"
mkdir -p logs
