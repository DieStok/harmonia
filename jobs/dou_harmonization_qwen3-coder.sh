...
#SBATCH --output=logs/dou_harmonization_qwen3-coder_%j.out
#SBATCH --error=logs/dou_harmonization_qwen3-coder_%j.err
...
echo "=============================================="
echo "Harmonia Experiment (GPU): dou_harmonization_qwen3-coder"
echo "=============================================="
echo ""
...
echo "Pre-loading model qwen3-coder:30b..."
curl -s http://localhost:11434/api/generate -d "{\"model\": \"qwen3-coder:30b\", \"prompt\": \"Hello\", \"stream\": false}" > /dev/null 2>&1 || echo "  Warning: Model pre-load may have failed"
...
echo "LLM Model: qwen3-coder:30b"
...
apptainer exec \
    ...
    --env LLM_SERVICE_MODEL=qwen3-coder:30b \
...
echo "Config: experiments/configs/dou_harmonization_qwen3-coder.yaml"
echo ""
...
python run_experiment.py \
    --config experiments/configs/dou_harmonization_qwen3-coder.yaml \
