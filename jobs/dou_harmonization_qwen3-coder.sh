...
LOG_OUT="logs/${LOG_TIMESTAMP}_dou_harmonization_qwen3-coder_${SLURM_JOB_ID}_${RUN_ID}.out"
LOG_ERR="logs/${LOG_TIMESTAMP}_dou_harmonization_qwen3-coder_${SLURM_JOB_ID}_${RUN_ID}.err"
mkdir -p logs
...
./exec_apptainer_harmonia.sh \
    --port $PORT \
    --config experiments/experiment_1_harmonia_dou2020_gdc/configs/automated/dou_harmonization_qwen3-coder.yaml \
    --job-name "dou_harmonization_qwen3-coder_${SLURM_JOB_ID}" \
    --run-id "$RUN_ID" &
...
echo "Config: experiments/experiment_1_harmonia_dou2020_gdc/configs/automated/dou_harmonization_qwen3-coder.yaml"
echo ""
