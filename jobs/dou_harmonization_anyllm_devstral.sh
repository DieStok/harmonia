...
LOG_OUT="logs/${LOG_TIMESTAMP}_dou_harmonization_anyllm_devstral_${SLURM_JOB_ID}_${RUN_ID}.out"
LOG_ERR="logs/${LOG_TIMESTAMP}_dou_harmonization_anyllm_devstral_${SLURM_JOB_ID}_${RUN_ID}.err"
mkdir -p logs
