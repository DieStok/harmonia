...
# Source config: experiments/experiment_1_harmonia_dou2020_gdc/configs/automated/dou_harmonization_bdikit-tools_nemotron-3-nano.yaml
# Template: sbatch_template_gpu.sh
# Re-generate with: python generate_jobs.py --config experiments/experiment_1_harmonia_dou2020_gdc/configs/automated/dou_harmonization_bdikit-tools_nemotron-3-nano.yaml
# ------------------------------------------------------------
# =============================================================================
...
RUN_RESULTS_DIR="results/${TIMESTAMP}_dou_harmonization_bdikit-tools_nemotron-3-nano_${SLURM_JOB_ID}_${RUN_ID}"
...
TOKEN=$(grep "^JUPYTER_TOKEN=" experiments/experiment_1_harmonia_dou2020_gdc/configs/automated/dou_harmonization_bdikit-tools_nemotron-3-nano_associated.env | cut -d '=' -f2)
