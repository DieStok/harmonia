...
#SBATCH --job-name=harmonia_dou_harmonization_kimi-k2
#SBATCH --output=logs/dou_harmonization_kimi-k2_%j.out
#SBATCH --error=logs/dou_harmonization_kimi-k2_%j.err
...
echo "=============================================="
echo "Harmonia Experiment (GPU): dou_harmonization_kimi-k2"
echo "=============================================="
echo ""
...
echo "Pre-loading model moonshotai/kimi-k2:free..."
curl -s http://localhost:11434/api/generate -d "{\"model\": \"moonshotai/kimi-k2:free\", \"prompt\": \"Hello\", \"stream\": false}" > /dev/null 2>&1 || echo "  Warning: Model pre-load may have failed"
...
echo "LLM Model: moonshotai/kimi-k2:free"
...
apptainer exec \
    ...
    --env LLM_SERVICE_MODEL=moonshotai/kimi-k2:free \
...
echo "Config: experiments/configs/dou_harmonization_kimi-k2.yaml"
echo ""
...
python run_experiment.py \
    --config experiments/configs/dou_harmonization_kimi-k2.yaml \
