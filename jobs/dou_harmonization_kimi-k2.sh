...
LOG_OUT="logs/${LOG_TIMESTAMP}_dou_harmonization_kimi-k2_${SLURM_JOB_ID}.out"
LOG_ERR="logs/${LOG_TIMESTAMP}_dou_harmonization_kimi-k2_${SLURM_JOB_ID}.err"
mkdir -p logs
exec > "$LOG_OUT" 2> "$LOG_ERR"

echo "=============================================="
echo "Harmonia Experiment: dou_harmonization_kimi-k2"
echo "=============================================="
echo ""
...
./exec_apptainer_harmonia.sh \
    --port $PORT \
    --config experiments/experiment_1_harmonia_dou2020_gdc/configs/automated/dou_harmonization_kimi-k2.yaml \
    --job-name "dou_harmonization_kimi-k2_${SLURM_JOB_ID}" &
...
echo "Config: experiments/experiment_1_harmonia_dou2020_gdc/configs/automated/dou_harmonization_kimi-k2.yaml"
echo ""
