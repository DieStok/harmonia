...
#SBATCH --job-name=harmonia_dou_harmonization_nemotron-3-nano
#SBATCH --output=logs/dou_harmonization_nemotron-3-nano_%j.out
#SBATCH --error=logs/dou_harmonization_nemotron-3-nano_%j.err
...
echo "=============================================="
echo "Harmonia Experiment (GPU): dou_harmonization_nemotron-3-nano"
echo "=============================================="
echo ""
...
echo "Pre-loading model nemotron-3-nano:30b..."
curl -s http://localhost:11434/api/generate -d "{\"model\": \"nemotron-3-nano:30b\", \"prompt\": \"Hello\", \"stream\": false}" > /dev/null 2>&1 || echo "  Warning: Model pre-load may have failed"
...
apptainer exec \
    ...
    --env LLM_SERVICE_MODEL=nemotron-3-nano:30b \
...
echo "Config: experiments/configs/dou_harmonization_nemotron-3-nano.yaml"
echo ""
...
python run_experiment.py \
    --config experiments/configs/dou_harmonization_nemotron-3-nano.yaml \
