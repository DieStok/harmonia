...
LOG_OUT="logs/${LOG_TIMESTAMP}_dou_harmonization_nemotron-3-nano_${SLURM_JOB_ID}.out"
LOG_ERR="logs/${LOG_TIMESTAMP}_dou_harmonization_nemotron-3-nano_${SLURM_JOB_ID}.err"
mkdir -p logs
