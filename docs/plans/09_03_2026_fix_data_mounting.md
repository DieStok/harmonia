...
Per CLAUDE.md, after significant code changes, update `docs/codebase_descriptions/`. Check if today's file (`how_this_codebase_works_09_03_2026.md`) exists; if so, add a section about the data isolation changes. If the date has changed, create a new file following the naming convention.
