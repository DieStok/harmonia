...
**Output produced:**
- `docs/processes/11_02_2026_interpreting_logs_and_traces.md` — comprehensive failure mode taxonomy with 13 categories, diagnostic flowchart, and remediations
...
| Write failure mode taxonomy doc | Done | `docs/processes/11_02_2026_interpreting_logs_and_traces.md` |
...
| Resource | Path |
|----------|------|
| Failure mode taxonomy | `docs/processes/11_02_2026_interpreting_logs_and_traces.md` |
