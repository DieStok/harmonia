...
<task-notification>
<task-id>bzat4vb6r</task-id>
<tool-use-id>toolu_01TjmMmhwHo1ChrR7HrtpDfQ</tool-use-id>
<output-file>REDACTED.output</output-file>
<status>completed</status>
<summary>Background command "Poll until all 7 jobs complete" completed (exit code 0)</summary>
</task-notification>
Read the output file to retrieve the result: REDACTED.output
