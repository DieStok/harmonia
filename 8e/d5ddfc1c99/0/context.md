...
Yes. Just cancel any still running jobs (automatic). Then update all their configs to have parameters at the top and the messages at the end. Then report on the container build process.
