...
- `results/<name>_<timestamp>/metrics.json` - Evaluation metrics (if gold standard configured)
- `results/<name>_<timestamp>/metrics_calculation.log` - Metrics calculation log (if run via calculate_metrics.py)
