...
- Follow latest instructions in:
  - `.claude/CLAUDE.md`
  - `documentation/codebase_descriptions/how_this_codebase_works_26_02_2026.md`
...
Create a single run ledger file in `documentation/plans/` or `documentation/processes/` with this mapping.
