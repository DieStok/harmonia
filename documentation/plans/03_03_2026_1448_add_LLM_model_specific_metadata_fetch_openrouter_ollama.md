...
Per CLAUDE.md instructions, update `documentation/codebase_descriptions/how_this_codebase_works_*.md` with the new registry system, `model_metadata` config section, and visualization changes.
