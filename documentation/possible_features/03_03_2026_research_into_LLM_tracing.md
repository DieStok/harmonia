...
Based on the landscape analysis (see `documentation/my_instructions/initial_info_LLM_tracing.md`), four candidates are carried forward for detailed evaluation:
